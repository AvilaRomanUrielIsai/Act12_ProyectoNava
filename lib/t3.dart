  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Series", style: TextStyle(color: Color(0xfff9fd16))),
        titleSpacing: 00.0,
        centerTitle: true,
        toolbarHeight: 60.2,
        toolbarOpacity: 0.8,
      ...
      body: Center(
        ...
        children: [
          Container(
              ...
              child: const TextField(
                decoration: InputDecoration(
                    hintText: "Ingrese su Id de la serie",
                    labelText: "Id_Serie",
          ...
          Container(
              ...
              child: const TextField(
                decoration: InputDecoration(
                    hintText: "Ingrese el nombre(s) del director(@s)",
                    labelText: "Director",
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: Color(0xff01075e))),
                    focusedBorder: OutlineInputBorder(
          ...
          Container(
              ...
              child: const TextField(
                decoration: InputDecoration(
                    hintText: "Ingrese los años activa",
                    labelText: "Años",
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: Color(0xff01075e))),
                    focusedBorder: OutlineInputBorder(
          ...
          Container(
              ...
              child: const TextField(
                decoration: InputDecoration(
                    hintText: "Ingrese la cantidad de temporadas",
